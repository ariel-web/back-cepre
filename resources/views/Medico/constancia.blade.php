        ...
        <table style="width:100%;">
            <tr>
                ...
                <td align="center" style="font-size:14pt; font-weight:700;">
                    ...
                    <div>EXAMEN EXTRAORDINARIO 2023-I</div>
                </td>
        ...
        <table style="width:100%; bakcground:orange; font-size:13pt; ">
            ...
            <tr>
                <td><div style="text-align:justify; margin-top:5px;">
                    Que el Sr(a): <span style="font-weight:700; text-transform: uppercase;">{{ $nombres }} {{ $paterno }} {{ $materno }}</span>, identificado con D.N.I. 
                    N°: <span style="font-weight:700;">{{ $dni }}</span>, postulante al programa de Estudios de 
            ...
            <tr>
                <td align="right"><div style="margin-top:10px;">Puno, {{$ldate}} de Enero de {{$lanio}}</div></td>
            </tr>
        </table>
    ...
    <div style="height:440px;">
        ...
        <table style="width:100%; bakcground:orange;">
            <tr>
                ...
                <td align="center" valign="center" style="font-size:17pt; font-weight:700;">CONSTANCIA</td>
                <td align="right" style="width:130px;" > 
                    <span style="font-size:8pt;"><?php   echo DNS1D::getBarcodeHTML('AADLYD','C128');?> </span>
                    <div> AADLYD </div>
                </td>
            </tr>
        </table>
        <table style="width:100%; bakcground:orange; font-size:13pt; ">
            ...
            <tr>
                <td><div style="text-align:justify; margin-top:5px;">
                    Que el Sr(a): <span style="font-weight:700;">JHON ARIEL LUQUE CUSACANI</span>, identificado con D.N.I. 
                    N°: <span style="font-weight:700;">70757838</span>, postulante al programa de Estudios de 
                    <span style="font-weight:700;">MEDICINA HUMANA</span>, ha cumplido con el 
                    <span style="font-weight:700;">EXAMEN MÉDICO</span> quedando <span style="font-weight:700;">APTO</span> para continuar su inscripción.</div></td>
            </tr>
            <tr>
                <td align="right"><div style="margin-top:10px;">Puno, 20 de Enero de 2023</div></td>
            </tr>
        </table>
